...
The following procedures have been adopted from the [Ada Initiative’s guide titled “Conference anti-harassment/Responding to Reports”](https://geekfeminism.fandom.com/wiki/Conference_anti-harassment/Responding_to_reports).
...
It was derived from the [ChefConf Code of Conduct](https://community.chef.io/code-of-conduct) which was forked from the [Geek Feminism wiki](https://geekfeminism.fandom.com/wiki/Conference_anti-harassment/Policy), created by the [Ada Initiative](https://adainitiative.org/) and other volunteers. It is also based on the [PyCon Code of Conduct](https://github.com/python/pycon-code-of-conduct).
